                ...
                <section className='flex max-sm:flex-col-reverse max-sm:gap-10 max-sm:px-3 items-center justify-center'>
                    ...
                    <section className='w-[60%] max-sm:w-[100%] flex flex-col items-start gap-4 max-sm:pr-0 max-sm:px-1 pr-20'>
                        ...
                        <div className="flex flex-col items-start gap-3 justify-center">
                            ...
                            <a href="https://www.linkedin.com/in/a-v-n-lalitha-kowtharapu-4baa57227/" className='px-4 mt-3 flex ml-2 items-center justify-center rounded-full  text-white gap-2 uppercase text-sm  bg-sky-400 py-1  '><span>Connect</span> <SiLinkedin className='h-6 w-6 ml-2' /></a>
                        </div>
                    </section>
